...
public class BluetoothPrintService {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        ...
        Message msg = mHandler.obtainMessage(SAFCONSTANT.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(SAFCONSTANT.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(SAFCONSTANT.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putInt(SAFCONSTANT.TOAST, R.string.connect_fail);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(SAFCONSTANT.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putInt(SAFCONSTANT.TOAST, R.string.connect_lost);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(SAFCONSTANT.MESSAGE_READ, bytes, -1, rcvData).sendToTarget();
                } catch (IOException e) {
